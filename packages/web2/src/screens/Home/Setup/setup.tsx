    ...
    <div className={cn("section", styles.section)}>
      <div className={cn("container", styles.container)}>
        <>
          {!wallet.connected && (
            <p>
              <Button className={cn("button-stroke", styles.button)} onClick={connect}>
                Connect
              </Button>{' '}
          ...
          {wallet.connected && !store && (
            <>
              ...
              <p>
                ...
                <Button className={cn("button-stroke", styles.button)} loading={isInitalizingStore} onClick={initializeStore}>
                  Init Store
                </Button>
              </p>
            </>
